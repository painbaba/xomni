...
- **एक command में install।** Windows + POSIX launchers, सभी 22 plugins अपने आप load।
...
- **1043 passing tests** पूरे plugin suite में (29 plugins)।
...
Launcher सभी 22 plugins के साथ Hermes host शुरू करता है — interactive chat, `-q` one-shots, `--continue` resume। Plugins drop-in install भी हो सकती हैं:
...
# ... पूरे suite में 1043 tests
```

Live verified (2026-08-12): **1043/1043 tests pass, 0 failures.**
