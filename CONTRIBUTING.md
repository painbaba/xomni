...
with **17 plugins** and a **677-test** suite. This guide covers how to add a
...
| Environment | Result |
|---|---|
| Windows 10/11, Python 3.11, git-bash (primary dev env) | ✅ 677/677 pass (17 plugins) |
...
3. **Run the matrix** (`bash .bench/run_all_tests.sh`) and confirm 677/677
