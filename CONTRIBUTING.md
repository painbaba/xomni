...
with **22 plugins** and a **842-test** suite. This guide covers how to add a
...
| Environment | Result |
|---|---|
| Windows 10/11, Python 3.11, git-bash (primary dev env) | ✅ 842/842 pass (22 plugins) |
...
3. **Run the matrix** (`bash .bench/run_all_tests.sh`) and confirm 842/842
