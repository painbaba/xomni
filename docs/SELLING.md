...
- Works on **Windows**, **one-command install**, sources MIT/Apache, **603 passing tests**
...
- 7 merged agents, 16 plugins, 25 verified free models, Windows support, one-command install, 603 tests.
...
- **README is the landing page.** One-command install at the very top, then a 10-second demo GIF, then the facts table (7 agents / 16 plugins / 25 verified free models / 603 tests). Screenshot of the sponsor line in action.
...
- **Build-in-public cadence** after launch: 3×/week — shipping updates, model-verification wins, sponsor-engine progress, test-count screenshots (603 and climbing).
...
- [ ] All 603 tests green on a clean clone; note the count in README
