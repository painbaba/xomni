...
| P1 | **Tool-search pattern** (on-demand tool loading) | 35 plugins + 311 MCP servers will blow the 30-50-tool accuracy ceiling; catalog-in-context, load-on-use | host-level pattern + mcp-catalog |
