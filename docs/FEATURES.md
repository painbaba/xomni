...
| Passing tests | **1251 / 1251** (0 failures) | `docs/TEST-MATRIX.md` (auto-generated 2026-08-17) |
...
**Totals: 35 plugins · 1251 test methods · 1251 passed · 0 failed** (TEST-MATRIX.md, 2026-08-17).
Row sum check: 15+14+19+16+18+28+31+69+40+28+22+130+87+13+67+31+21+14+8+27+29+20+22+47+26+27+37+20+42+75+26+19+29+32+46+22+34 = 1251 ✓
...
| `TEST-MATRIX.md` | Auto-generated plugin test matrix — 1251/1251 PASS (2026-08-17) | SHIPPED (regenerated by the test harness) |
...
| `.bench/` | Benchmark harness: `bench.py`, `run_all_tests.sh`, `results[-before|-after].json` over the 1251-test suite | SHIPPED |
