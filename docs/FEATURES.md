...
| Passing tests | **647 / 647** (0 failures) | `docs/TEST-MATRIX.md` (auto-generated 2026-08-12 00:27) |
...
| 17 | `omni-skills` | SKILL.md interop: scan/validate/install skills from any marketplace — zero hooks | 12 | SHIPPED | Claude (SKILL.md standard) |

**Totals: 17 plugins · 647 test methods · 647 passed · 0 failed** (TEST-MATRIX.md, 2026-08-12 00:27).
Row sum check: 34+18+36+31+42+26+42+69+38+99+87+32+26+27+8+20 = 647 ✓
...
| `TEST-MATRIX.md` | Auto-generated plugin test matrix — 647/647 PASS (2026-08-12 00:27) | SHIPPED (regenerated by the test harness) |
...
| `.bench/` | Benchmark harness: `bench.py`, `run_all_tests.sh`, `results[-before|-after].json` over the 647-test suite | SHIPPED |
